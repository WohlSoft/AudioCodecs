...
compatible with one of included license at every sub-project, or may introduce
...
author and that you are contributing your changes under the GPLv2+, LGPLv2.1+,
MIT, Zlib, BSD-3-Clause, and Artistic licenses depending on the target
sub-project.
